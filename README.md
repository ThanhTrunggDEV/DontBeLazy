...
| Tính năng | Mô tả |
|---|---|
| 📋 **Task Management** | Tạo danh sách công việc cần làm, gắn thời gian Pomodoro |
| 🔒 **Whitelist per Task** | Mỗi task có một bộ Whitelist Profile riêng — Task "Code" chỉ mở VS Code, Task "Học" chỉ mở từ điển |
| 🛡️ **Focus Mode** | Kích hoạt khiên chặn toàn bộ internet & app ngoài Whitelist |
...
| 💬 **Motivation Quotes** | Tự động hiện câu truyền cảm hứng tại các thời điểm chiến lược |
...
- **Guilt-tripping:** Màn hình đỏ hỏi thẳng vào mặt bạn trước khi cho phép thoát.
...
Dự án hiện đang ở giai đoạn **lên kế hoạch & thiết kế**. Tất cả tài liệu BA và Use Cases đã hoàn thiện, sẵn sàng chuyển sang giai đoạn phát triển.
