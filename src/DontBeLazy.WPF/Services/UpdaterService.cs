...
public class UpdaterService
{
    ...
    /// <summary>
    /// Downloads the zip, extracts beside the current exe, then restarts the app.
    ...
    {
        var tempZip  = Path.Combine(Path.GetTempPath(), $"DontBeLazy-{release.Version}.zip");
        ...
        // Waits for this process to exit, copies files, then relaunches.
        ...
        // Trigger shutdown — the batch script handles the rest
